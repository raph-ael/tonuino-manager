...
let mainWindow, newFolderWindow, workerWindow;
...
const createWindowNewFolder = () => {
  ...
  newFolderWindow.loadURL(NEW_FOLDER_WINDOW_WEBPACK_ENTRY);

  ipcMain.on('open-new-folder', (event, arg) => {
